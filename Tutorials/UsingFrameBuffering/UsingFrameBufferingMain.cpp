#include "pch.h"
#include "UsingFrameBufferingMain.h"
#include "Common\DirectXHelper.h"

using namespace UsingFrameBuffering;
...
UsingFrameBufferingMain::UsingFrameBufferingMain()
{
...
// 렌더러를 만들고 초기화합니다.
void UsingFrameBufferingMain::CreateRenderers(const std::shared_ptr<DX::DeviceResources>& deviceResources)
{
...
void UsingFrameBufferingMain::Update()
{
	// 장면 개체를 업데이트합니다.
	m_timer.Tick([&]()
	{
...
bool UsingFrameBufferingMain::Render()
{
...
void UsingFrameBufferingMain::OnWindowSizeChanged()
{
...
void UsingFrameBufferingMain::OnSuspending()
{
...
void UsingFrameBufferingMain::OnResuming()
{
	// TODO: 이것을 앱의 다시 시작 논리로 바꾸세요.
}

// 릴리스가 필요한 장치 리소스를 렌더러에 알립니다.
void UsingFrameBufferingMain::OnDeviceRemoved()
{
