...
namespace DX
{
	...
	public:
		...
		ID3D12CommandAllocator*		GetBundleAllocator() const			{ return m_bundleAllocators[m_currentFrame].Get(); }
	...
	private:
		...
		Microsoft::WRL::ComPtr<ID3D12CommandAllocator>	m_bundleAllocators[c_frameCount];
